...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            dataTable.addRows([
                ...
                {{--[ '완료', '{{$week->todo->name}}', new Date(0,0,0,{{date("H",strtotime($todo->v_stime))}},{{date("i",strtotime($todo->v_stime))}},0), new Date(0,0,0,{{date("H",strtotime($todo->v_etime))}},{{date("i",strtotime($todo->v_etime))}},0) ],--}}
    ...
    <div id="daily" class="mt-2" style="min-height: 700px"></div>
